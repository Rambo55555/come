...
def cal_bleu(predictions, reference_file):
  preds = []
  with open(predictions, 'r') as f:
    preds = ["{}\t{}".format(idx, line) for idx, line in enumerate(f.readlines())]
  (goldMap, predictionMap) = computeMaps(preds, reference_file) 
...
if __name__ == '__main__':
  ...
  print ("Smooth BLEU=", bleuFromMaps(goldMap, predictionMap)[0])
